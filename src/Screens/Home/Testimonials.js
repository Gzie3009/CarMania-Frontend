...
import 'swiper/css';
import sanket from "../../Assets/testimonial/sanket.jpeg";
import prashant from "../../Assets/testimonial/prashant.jpeg";
import dibyo from "../../Assets/testimonial/dibyo.jpeg";
import gaurav from "../../Assets/testimonial/gaurav.jpeg";
import divyansh from "../../Assets/testimonial/divyansh.jpeg";
import ashutosh from "../../Assets/testimonial/ashutosh.jpeg";
  ...
  return (
    <>  <div className='mt-20 mb-20' id='Testimonials'>
        <div className='w-full text-center mb-16'>
            ...
            <div className='h-full w-full font-bold text-4xl'>
            ...
            <SwiperSlide>
              ...
              <div className='h-[60vh] w-2/3 flex'>
                ...
                <div className='pl-24 h-3/4 w-2/3 text-4xl flex flex-col justify-between'>
                  ...
                  <p className='mt-5 font-semibold'>Prashant Mishra , CEO @Mishra Constructions Pvt Ltd</p>
                  <p className='flex'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
